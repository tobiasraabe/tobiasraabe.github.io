...
def process_settings(pelicanobj):
    ...
    mathjax_settings[
        ...
        True
    )  # if set to true, it will insert mathjax script automatically into content without needing to alter the template.
    mathjax_settings[
        "align"
    ] = (
        "center"
    )  # controls alignment of of displayed equations (values can be: left, right, center)
    mathjax_settings[
        "indent"
    ...
    mathjax_settings[
        ...
        "false"
    )  # Set to false by default for performance reasons (see http://docs.mathjax.org/en/latest/output.html#automatic-line-breaking)
    mathjax_settings[
        "tex_extensions"
    ] = (
        ""
    ...
    mathjax_settings[
        ...
        "normal"
    )  # This value controls the verbosity of the messages in the lower left-hand corner. Set it to "none" to eliminate all messages
